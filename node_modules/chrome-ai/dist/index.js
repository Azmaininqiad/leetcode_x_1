...
__export(src_exports, {
  ChromeAIChatLanguageModel: () => ChromeAIChatLanguageModel,
  ChromeAIEmbeddingModel: () => ChromeAIEmbeddingModel,
  PolyfillChromeAIAssistantFactory: () => PolyfillChromeAIAssistantFactory,
  chromeai: () => chromeai,
  polyfillChromeAI: () => polyfillChromeAI
});
...
var debug = (0, import_debug.default)("chromeai");
...
// src/language-model.ts
var debug2 = (0, import_debug2.default)("chromeai");
function getStringContent(content) {
  if (typeof content === "string") {
    ...
    const [first] = content;
    if (first.type !== "text") {
      throw new import_provider.UnsupportedFunctionalityError({ functionality: "toolCall" });
    }
...
var debug3 = (0, import_debug3.default)("chromeai");
...
var debug4 = (0, import_debug4.default)("chromeai:polyfill");
